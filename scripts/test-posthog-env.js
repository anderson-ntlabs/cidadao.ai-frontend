...
console.log(`   NEXT_PUBLIC_POSTHOG_KEY: ${apiKey ? '✅ Set (' + apiKey.substring(0, 8) + '...)' : '❌ Not set'}`)
...
if (fs.existsSync(envLocalPath)) {
  ...
  console.log(`   .env.local contains POSTHOG_HOST: ${hasPosthogHost ? '✅ Yes' : '⚠️  No (optional)'}`)
}
...
if (!apiHost) {
  console.log('   ⚠️  NEXT_PUBLIC_POSTHOG_HOST not set (will use default: https://us.i.posthog.com)')
