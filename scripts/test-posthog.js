...
function testPostHogConfig() {
  ...
  functions.forEach((fn) => {
    if (configContent.includes(`export function ${fn}`) || configContent.includes(`export const ${fn}`)) {
...
function testUsabilityTracker() {
  ...
  trackingFunctions.forEach((fn) => {
    if (trackerContent.includes(`export function ${fn}`) || trackerContent.includes(`export const ${fn}`)) {
