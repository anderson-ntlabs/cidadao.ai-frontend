...
async function runTests() {
  ...
  await testEndpoint(
    'Maritaca Direct Chat',
    'POST',
    '/api/v1/chat/direct/maritaca',
    {
      messages: [
        { role: 'user', content: 'Explique o que é o Portal da Transparência' }
      ],
      model: 'sabiazinho-3',
  ...
  await testEndpoint(
    'Coverage Summary',
    'GET',
    '/api/v1/transparency/coverage/summary'
  );
  ...
  // Test IBGE states
  results.federal = await testEndpoint(
    'IBGE - List States',
    'GET',
    '/api/v1/federal/ibge/states'
  );

  // Test IBGE municipalities (Rio de Janeiro)
  await testEndpoint(
    'IBGE - Municipalities (RJ)',
    'POST',
    '/api/v1/federal/ibge/municipalities',
    { state_code: '33' }
  );
  ...
  await testEndpoint(
    ...
    'POST',
    '/api/v1/federal/datasus/indicators',
    { state: 'RJ', year: 2024 }
  );
