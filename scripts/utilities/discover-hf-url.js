...
function checkCompletion() {
  if (completed === possibleUrls.length) {
    ...
    if (foundUrl) {
      ...
      console.log('\nPlease check:')
      console.log(
        '1. Is the Space running? Check: https://huggingface.co/spaces/neural-thinker/cidadao.ai-backend'
      )
      console.log(
        '2. In the "App" tab, right-click and "Open frame in new tab" to get the direct URL'
      )
