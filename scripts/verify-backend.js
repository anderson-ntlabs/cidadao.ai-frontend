...
const baseUrl = 'https://huggingface.co/spaces/neural-thinker/cidadao.ai-backend';
...
setTimeout(() => {
  ...
  https.get(`${baseUrl}/api/v1/chat/suggestions`, (res) => {
    console.log(`   Status: ${res.statusCode}`);
...
setTimeout(() => {
  ...
  const options = {
    ...
    path: '/spaces/neural-thinker/cidadao.ai-backend/api/v1/chat/message',
    method: 'POST',
    headers: {
