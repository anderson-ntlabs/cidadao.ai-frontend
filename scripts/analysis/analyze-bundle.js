...
try {
  ...
  if (dependencies.includes('moment')) {
    console.log(
      `${colors.red}✗ moment.js detected - Consider using date-fns or native Intl${colors.reset}`
    )
  }
  ...
  if (dependencies.includes('lodash')) {
    console.log(
      `${colors.yellow}! lodash detected - Use lodash-es or specific imports${colors.reset}`
    )
  }
