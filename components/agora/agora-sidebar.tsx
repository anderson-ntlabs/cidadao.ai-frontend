...
export function AgoraSidebar({ user, className }: AgoraSidebarProps) {
  ...
  return (
    ...
    >
      ...
      <div className="p-6 border-b border-gray-200/50 dark:border-gray-800/50">
        <Link href="/pt/agora" className="flex items-center gap-3 group">
          ...
          <div>
            <h2 className="font-bold text-lg text-gray-900 dark:text-gray-100">Ágora</h2>
