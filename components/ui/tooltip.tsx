              ...
              >
                ...
                <div
                  className={cn(
                    ...
                    position === 'top' && 'bottom-[-8px] left-1/2 -translate-x-1/2 border-l-[8px] border-r-[8px] border-t-[8px] border-l-transparent border-r-transparent border-t-gray-900',
                    position === 'bottom' && 'top-[-8px] left-1/2 -translate-x-1/2 border-l-[8px] border-r-[8px] border-b-[8px] border-l-transparent border-r-transparent border-b-gray-900',
                    position === 'left' && 'right-[-8px] top-1/2 -translate-y-1/2 border-t-[8px] border-b-[8px] border-l-[8px] border-t-transparent border-b-transparent border-l-gray-900',
                    position === 'right' && 'left-[-8px] top-1/2 -translate-y-1/2 border-t-[8px] border-b-[8px] border-r-[8px] border-t-transparent border-b-transparent border-r-gray-900'
                  )}
                />
              </motion.div>
            )}
...
interface StrategicTooltipProps extends Omit<TooltipProps, 'content' | 'showOnce'> {
  tooltipKey: 'first-chat' | 'upload-hint' | 'agent-selector' | 'export-data' | 'chat-history' | 'send-message' | 'contrast-toggle';
  content?: string | React.ReactNode;
}
...
export function StrategicTooltip({ 
  ...
  return (
    <Tooltip
      content={content || strategicContent[tooltipKey]}
      showOnce
      dismissible
      {...props}
    >
