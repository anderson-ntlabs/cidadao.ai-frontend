/**
 * Agora Analytics Tracker
 *
 * Tracks user interactions within the Agora module for:
 ...
 */
function trackAgoraEvent(eventName: string, properties: Record<string, any>) {
  // Log in development for debugging
  if (process.env.NODE_ENV === 'development') {
    const hasConsent = hasUserConsent()
    logger.debug(`[Agora Telemetry] ${eventName}`, {
      context: 'AgoraTracker',
      eventName,
      properties,
      hasConsent,
      willSend: hasConsent,
...
export function trackAgendaView() {
  trackAgoraEvent('agora_agenda_viewed', {
    component: 'agenda',
    action: 'view',
  })
}
...
export function trackAgendaEventCreated(data: AgendaTrackingData) {
  trackAgoraEvent('agora_agenda_event_created', {
    component: 'agenda',
    action: 'create',
...
export function trackAgendaEventCompleted(data: AgendaTrackingData) {
  trackAgoraEvent('agora_agenda_event_completed', {
    component: 'agenda',
    action: 'complete',
    event_type: data.eventType,
    event_title: data.eventTitle,
...
export function trackAgendaEventDeleted(data: AgendaTrackingData) {
  trackAgoraEvent('agora_agenda_event_deleted', {
    component: 'agenda',
    action: 'delete',
    event_type: data.eventType,
    event_title: data.eventTitle,
...
export function trackAgendaViewChange(viewType: 'month' | 'week' | 'list') {
  trackAgoraEvent('agora_agenda_view_changed', {
    component: 'agenda',
    action: 'view_change',
    view_type: viewType,
  })
...
export function trackGoogleCalendarExport(eventCount: number) {
  trackAgoraEvent('agora_agenda_google_export', {
    component: 'agenda',
    action: 'export',
...
export function trackStudySession(data: StudySessionData) {
  trackAgoraEvent('agora_study_session', {
    component: 'study',
...
export function trackContentProgress(data: ContentData) {
  trackAgoraEvent('agora_content_progress', {
    component: 'content',
...
export function trackVideoCompleted(videoId: string, videoTitle: string, durationSeconds: number) {
  trackAgoraEvent('agora_video_completed', {
    component: 'videos',
    action: 'complete',
    video_id: videoId,
...
export function trackReadingCompleted(readingId: string, readingTitle: string) {
  trackAgoraEvent('agora_reading_completed', {
    component: 'readings',
    action: 'complete',
...
export function trackDiaryEntryCreated(mood: string, wordCount: number) {
  trackAgoraEvent('agora_diary_entry_created', {
    component: 'diary',
    action: 'create',
    mood: mood,
...
export function trackMilestone(data: MilestoneData) {
  trackAgoraEvent('agora_milestone_achieved', {
...
export function trackBadgeEarned(badgeId: string, badgeName: string) {
  trackAgoraEvent('agora_badge_earned', {
    component: 'gamification',
    action: 'badge',
    badge_id: badgeId,
...
export function trackCertificateDownload(totalHours: number, level: number) {
  trackAgoraEvent('agora_certificate_downloaded', {
...
export function trackReportDownload(totalHours: number, totalXp: number) {
  trackAgoraEvent('agora_report_downloaded', {
    component: 'certificate',
...
export function trackMentorChat(agentId: string, messageCount: number) {
  trackAgoraEvent('agora_mentor_chat', {
    component: 'chat',
    action: 'message',
    agent_id: agentId,
...
export function trackTrackEnrollment(trackId: string, trackName: string) {
  trackAgoraEvent('agora_track_enrolled', {
    component: 'tracks',
    action: 'enroll',
    track_id: trackId,
...
export function trackTrackCompleted(trackId: string, trackName: string, totalXp: number) {
  trackAgoraEvent('agora_track_completed', {
    component: 'tracks',
    action: 'complete',
    track_id: trackId,
    track_name: trackName,
