...
<div className="flex flex-col gap-2 sm:flex-row sm:items-center">
  ...
  <button className="w-full sm:w-auto py-3 sm:py-2">🏛️ Cidadão.AI</button>
  <button className="w-full sm:w-auto py-3 sm:py-2">🦜 Maritaca Direto</button>
</div>
```
...
<Collapsible defaultOpen={!isMobile}>
  <CollapsibleTrigger className="sm:hidden">ℹ️ Info</CollapsibleTrigger>
  <CollapsibleContent>
...
const MaritacaModelSelector = dynamic(() => import('@/components/chat/maritaca-model-selector'), {
