...
export const H1 = ({ children }) => (
  <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100">{children}</h1>
)

export const H2 = ({ children }) => (
  <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200">{children}</h2>
)
```
