...
background: linear-gradient(to bottom right, from-gray-900 via-gray-800 to-gray-900);

/* Overlay de gradiente verde-azul */
background: linear-gradient(to top right, from-green-900/20 to-blue-900/20);
```
