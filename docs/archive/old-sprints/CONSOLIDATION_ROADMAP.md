...
_"Eliminar complexidade desnecessária"_
...
export default {
  experimental: {
    optimizeCss: true,
    optimizePackageImports: ['d3', 'recharts', 'lucide-react'],
  },
