...
export const BACKEND_TRACK: TrackContent = {
  ...
  modules: [
    ...
    },
    {
      ...
      xpReward: 130,
      diaryPrompt:
        'Qual estrutura de dados você achou mais útil? Em que situações você usaria cada uma?',
...
export const INTRODUCAO_TRACK: TrackContent = {
  ...
  mentor: {
    ...
    name: 'Abaporu',
    greeting:
      'Bem-vindo ao Cidadão.AI! Sou Abaporu, o agente orquestrador inspirado na obra de Tarsila do Amaral. Vou te guiar pelos primeiros passos nesta jornada incrível!',
    videoIntro: 'Assista os vídeos para conhecer nossa plataforma. Escolha o estilo que preferir!',
    diaryEncouragement:
      'Excelente! Anotar suas impressões ajuda a fixar o conhecimento. Quanto mais escrever, mais XP ganha!',
    chatInvitation: 'Tem dúvidas sobre o projeto ou a plataforma? Estou aqui para ajudar!',
  },
  modules: [
    {
      id: 1,
      title: 'Bem-vindo ao Cidadão.AI',
      description: 'Conheça o projeto de transparência pública com IA',
      objectives: [
        'Entender a missão do Cidadão.AI',
        'Conhecer a arquitetura do projeto',
        'Descobrir como você pode contribuir',
      ],
      videos: [
        {
          style: 'academic',
          title: 'Transparência Pública e Dados Abertos',
          channel: 'CGU',
          channelUrl: 'https://www.youtube.com/c/cikigovbr',
          videoId: 'PLqRhc6k',
          duration: '15min',
          description: 'O que é transparência pública e por que importa',
        },
        {
          style: 'didactic',
          ...
          videoId: 'a8ftGUIm9jE',
          duration: '12min',
          description: 'Como funciona software de código aberto',
        },
        {
          style: 'practical',
      ...
      xpReward: 50,
      diaryPrompt:
        'O que te motivou a participar do Cidadão.AI? Como você acha que pode contribuir?',
      chatPrompt: 'Vamos conversar sobre o projeto e como você pode ajudar!',
    },
    {
      id: 2,
      title: 'Como Funciona a Ágora',
      ...
      videos: [
        {
          ...
          videoId: 'kN_Xpvmxn-Y',
          duration: '25min',
          description: 'Teoria de gamificação educacional',
        },
        {
          style: 'didactic',
          title: 'Aprendizado Ativo e Prático',
          channel: 'Nerdologia',
        ...
        },
        {
          ...
          videoId: 'TjPXpfD4atE',
          duration: '15min',
          description: 'Dicas práticas de estudo para devs',
        },
      ],
      xpReward: 40,
      diaryPrompt: 'Como você pretende organizar seus estudos na Ágora? Quantas horas por semana?',
      chatPrompt: 'Posso te ajudar a criar um plano de estudos personalizado!',
    },
    {
      id: 3,
      title: 'Conheça os Agentes de IA',
      ...
      xpReward: 50,
      diaryPrompt: 'Qual agente te interessou mais? Zumbi, Anita, Tiradentes? Por quê?',
      chatPrompt: 'Quer saber mais sobre algum agente específico?',
    },
    {
      id: 4,
      title: 'Configurando seu GitHub',
      description: 'Prepare seu ambiente para contribuir com código',
      objectives: [
        'Criar ou configurar conta GitHub',
        'Fazer fork do repositório',
        'Entender o fluxo de contribuição',
      ],
      videos: [
        {
          style: 'academic',
        ...
        },
        {
          ...
          videoId: 'UBAX-13g8OM',
          duration: '25min',
          description: 'Contribuindo na prática',
        },
      ],
      exercise: {
        type: 'reflection',
        question: 'Descreva o que você fez: criou conta, fez fork, etc.',
        minWords: 20,
      },
      xpReward: 100,
      diaryPrompt: 'Qual é seu usuário do GitHub? O que você achou do processo de fork?',
      chatPrompt: 'Precisa de ajuda com Git ou GitHub? Posso te guiar!',
    },
    {
      id: 5,
      title: 'Conversa com Abaporu',
      description: 'Sua primeira interação com um agente mentor',
      objectives: [
        'Praticar interação com agente IA',
      ...
      videos: [
        ...
        {
          style: 'didactic',
          title: 'Engenharia de Prompts Básica',
          channel: 'Código Fonte TV',
          channelUrl: 'https://www.youtube.com/c/CodigoFonteTV',
          videoId: '5DkWHqYDgvs',
          duration: '15min',
      ...
      xpReward: 60,
      diaryPrompt: 'O que você achou de conversar com um agente de IA? Foi útil?',
      chatPrompt:
        'Olá! Sou Abaporu, o orquestrador. Pode me perguntar qualquer coisa sobre o projeto!',
    },
    {
      id: 6,
      title: 'Próximo Passo: Sua Trilha',
      description: 'Escolha sua especialização e comece a jornada',
      objectives: [
        'Revisar o que aprendeu',
        'Escolher sua trilha de especialização',
      ...
      videos: [
        {
          ...
          videoId: 'Kpk-MZTkPe0',
          duration: '25min',
          description: 'Panorama das áreas de TI',
        },
        {
          style: 'didactic',
          ...
          videoId: 'ghTrp1x_1As',
          duration: '15min',
          description: 'Comparando as áreas',
        },
        {
          style: 'practical',
          title: 'Como Escolher sua Área',
          channel: 'Filipe Deschamps',
          channelUrl: 'https://www.youtube.com/c/FilipeDeschamps',
          videoId: 'BTENKdRVS2U',
          duration: '12min',
      ...
      xpReward: 50,
      diaryPrompt: 'Qual trilha você escolheu? Backend, Frontend, IA/ML ou DevOps? Por quê?',
      chatPrompt: 'Parabéns por completar a introdução! Qual trilha você vai seguir?',
    },
  ],
  totalXp: 500,
  certificateHours: 2,
