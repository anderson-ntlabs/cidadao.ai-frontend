...
// Introducao Track Content - Required before other tracks
export const INTRODUCAO_TRACK: TrackContent = {
  id: 'introducao',
  name: 'Introducao',
  mentor: {
    id: 'abaporu',
    name: 'Abaporu',
    greeting:
      'Bem-vindo ao Cidadao.AI! Sou Abaporu, o agente orquestrador inspirado na obra de Tarsila do Amaral. Vou te guiar pelos primeiros passos nesta jornada incrivel!',
    videoIntro: 'Assista os videos para conhecer nossa plataforma. Escolha o estilo que preferir!',
    diaryEncouragement:
      'Excelente! Anotar suas impressoes ajuda a fixar o conhecimento. Quanto mais escrever, mais XP ganha!',
    chatInvitation: 'Tem duvidas sobre o projeto ou a plataforma? Estou aqui para ajudar!',
  },
  modules: [
    {
      id: 1,
      title: 'Bem-vindo ao Cidadao.AI',
      description: 'Conheca o projeto de transparencia publica com IA',
      objectives: [
        'Entender a missao do Cidadao.AI',
        'Conhecer a arquitetura do projeto',
        'Descobrir como voce pode contribuir',
      ],
      videos: [
        {
          style: 'academic',
          title: 'Transparencia Publica e Dados Abertos',
          channel: 'CGU',
          channelUrl: 'https://www.youtube.com/c/cikigovbr',
          videoId: 'PLqRhc6k',
          duration: '15min',
          description: 'O que e transparencia publica e por que importa',
        },
        {
          style: 'didactic',
          title: 'Open Source para Iniciantes',
          channel: 'Codigo Fonte TV',
          channelUrl: 'https://www.youtube.com/c/CodigoFonteTV',
          videoId: 'a8ftGUIm9jE',
          duration: '12min',
          description: 'Como funciona software de codigo aberto',
        },
        {
          style: 'practical',
          title: 'Sua Primeira Contribuicao Open Source',
          channel: 'Rafaella Ballerini',
          channelUrl: 'https://www.youtube.com/c/RafaellaBallerini',
          videoId: 'mcd7lXpfYIs',
          duration: '20min',
          description: 'Passo a passo para contribuir',
        },
      ],
      xpReward: 50,
      diaryPrompt:
        'O que te motivou a participar do Cidadao.AI? Como voce acha que pode contribuir?',
      chatPrompt: 'Vamos conversar sobre o projeto e como voce pode ajudar!',
    },
    {
      id: 2,
      title: 'Como Funciona a Agora',
      description: 'Entenda a plataforma de aprendizado gamificada',
      objectives: [
        'Conhecer o sistema de XP e badges',
        'Entender as trilhas de aprendizado',
        'Saber como ganhar o certificado',
      ],
      videos: [
        {
          style: 'academic',
          title: 'Gamificacao na Educacao',
          channel: 'UNIVESP',
          channelUrl: 'https://www.youtube.com/user/univesptv',
          videoId: 'kN_Xpvmxn-Y',
          duration: '25min',
          description: 'Teoria de gamificacao educacional',
        },
        {
          style: 'didactic',
          title: 'Aprendizado Ativo e Pratico',
          channel: 'Nerdologia',
          channelUrl: 'https://www.youtube.com/c/Nerdologia',
          videoId: 'pMc9hJAqFLA',
          duration: '12min',
          description: 'Por que aprender fazendo funciona',
        },
        {
          style: 'practical',
          title: 'Organizando seus Estudos',
          channel: 'Programacao Dinamica',
          channelUrl: 'https://www.youtube.com/c/ProgramacaoDinamica',
          videoId: 'TjPXpfD4atE',
          duration: '15min',
          description: 'Dicas praticas de estudo para devs',
        },
      ],
      xpReward: 40,
      diaryPrompt: 'Como voce pretende organizar seus estudos na Agora? Quantas horas por semana?',
      chatPrompt: 'Posso te ajudar a criar um plano de estudos personalizado!',
    },
    {
      id: 3,
      title: 'Conheca os Agentes de IA',
      description: 'Descubra os 17 agentes brasileiros do sistema',
      objectives: [
        'Conhecer os principais agentes',
        'Entender o papel de cada um',
        'Saber quando usar cada agente',
      ],
      videos: [
        {
          style: 'academic',
          title: 'Agentes de IA - Conceitos',
          channel: 'UNIVESP',
          channelUrl: 'https://www.youtube.com/user/univesptv',
          videoId: 'g0Rd_zLqXwU',
          duration: '30min',
          description: 'Teoria sobre agentes inteligentes',
        },
        {
          style: 'didactic',
          ...
          videoId: 'RvT8K0J6FdM',
          duration: '18min',
          description: 'Entendendo LLMs e agentes',
        },
        {
          style: 'practical',
          title: 'Conversando com IA de Forma Eficiente',
          channel: 'Filipe Deschamps',
          channelUrl: 'https://www.youtube.com/c/FilipeDeschamps',
          videoId: 'jC4v5AS4RIM',
          duration: '20min',
          description: 'Dicas para usar IA no dia a dia',
        },
      ],
      xpReward: 50,
      diaryPrompt: 'Qual agente te interessou mais? Zumbi, Anita, Tiradentes? Por que?',
      chatPrompt: 'Quer saber mais sobre algum agente especifico?',
    },
    {
      id: 4,
      title: 'Configurando seu GitHub',
      description: 'Prepare seu ambiente para contribuir com codigo',
      objectives: [
        'Criar ou configurar conta GitHub',
        'Fazer fork do repositorio',
        'Entender o fluxo de contribuicao',
      ],
      videos: [
        {
          style: 'academic',
          ...
          videoId: 'UBAX-13g8OM',
          duration: '28min',
          description: 'Teoria de versionamento',
        },
        {
          style: 'didactic',
          title: 'Curso Git e GitHub Completo',
          channel: 'Curso em Video',
          channelUrl: 'https://www.youtube.com/c/CursoemVideo',
          videoId: 'xEKo29OWILE',
          duration: '35min',
        ...
        {
          style: 'practical',
          title: 'Fazendo Fork e Pull Request',
          channel: 'Rafaella Ballerini',
          channelUrl: 'https://www.youtube.com/c/RafaellaBallerini',
          videoId: 'UBAX-13g8OM',
          duration: '25min',
          description: 'Contribuindo na pratica',
        },
      ],
      exercise: {
        type: 'reflection',
        question: 'Descreva o que voce fez: criou conta, fez fork, etc.',
        minWords: 20,
      },
      xpReward: 100,
      diaryPrompt: 'Qual e seu usuario do GitHub? O que voce achou do processo de fork?',
      chatPrompt: 'Precisa de ajuda com Git ou GitHub? Posso te guiar!',
    },
    {
      id: 5,
      title: 'Conversa com Abaporu',
      description: 'Sua primeira interacao com um agente mentor',
      objectives: [
        'Praticar interacao com agente IA',
        'Tirar duvidas sobre o projeto',
        'Conhecer as capacidades do mentor',
      ],
      videos: [
        {
          style: 'academic',
          title: 'Dialogos com IA',
          channel: 'USP',
          channelUrl: 'https://www.youtube.com/user/uspdigitais',
          videoId: 'zjkBMFhNj_g',
          duration: '20min',
          description: 'Como interagir efetivamente com IA',
        },
        {
          style: 'didactic',
          title: 'Engenharia de Prompts Basica',
          channel: 'Codigo Fonte TV',
          channelUrl: 'https://www.youtube.com/c/CodigoFonteTV',
          videoId: '5DkWHqYDgvs',
          duration: '15min',
          description: 'Como fazer boas perguntas para IA',
        },
        {
          style: 'practical',
          title: 'Usando IA como Ferramenta de Estudo',
          channel: 'Programacao Dinamica',
          channelUrl: 'https://www.youtube.com/c/ProgramacaoDinamica',
          videoId: 'Lx9dhtPjPEg',
          duration: '18min',
          description: 'Dicas praticas',
        },
      ],
      xpReward: 60,
      diaryPrompt: 'O que voce achou de conversar com um agente de IA? Foi util?',
      chatPrompt:
        'Ola! Sou Abaporu, o orquestrador. Pode me perguntar qualquer coisa sobre o projeto!',
    },
    {
      id: 6,
      title: 'Proximo Passo: Sua Trilha',
      description: 'Escolha sua especializacao e comece a jornada',
      objectives: [
        'Revisar o que aprendeu',
        'Escolher sua trilha de especializacao',
      ...
      videos: [
        {
          ...
          videoId: 'Kpk-MZTkPe0',
          duration: '25min',
          description: 'Panorama das areas de TI',
        },
        {
          style: 'didactic',
          title: 'Backend vs Frontend vs IA',
          channel: 'Codigo Fonte TV',
          channelUrl: 'https://www.youtube.com/c/CodigoFonteTV',
          videoId: 'ghTrp1x_1As',
          duration: '15min',
          description: 'Comparando as areas',
        },
        {
          style: 'practical',
          title: 'Como Escolher sua Area',
          channel: 'Filipe Deschamps',
          channelUrl: 'https://www.youtube.com/c/FilipeDeschamps',
          videoId: 'BTENKdRVS2U',
          duration: '12min',
          description: 'Dicas para decidir',
        },
      ],
      xpReward: 50,
      diaryPrompt: 'Qual trilha voce escolheu? Backend, Frontend, IA/ML ou DevOps? Por que?',
      chatPrompt: 'Parabens por completar a introducao! Qual trilha voce vai seguir?',
    },
  ],
  totalXp: 500,
  certificateHours: 2,
