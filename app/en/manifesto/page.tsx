...
export const metadata: Metadata = {
  ...
  description:
    'For an Artificial Intelligence that serves the people and illuminates the State. Cidadão.AI project manifesto.',
}
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-24">
        ...
        {/* Anthropophagy Image - Tarsila do Amaral */}
        <div className="my-12 rounded-lg overflow-hidden shadow-2xl border-4 border-green-600 dark:border-green-400">
          <Image
            ...
            alt="Antropofagia by Tarsila do Amaral - Brazilian Anthropophagic Movement"
            width={1200}
            height={800}
          ...
          <div className="bg-green-50 dark:bg-green-900/20 p-4 text-center">
            ...
            <p className="text-xs text-green-700 dark:text-green-300 mt-1">
              Symbol of the Anthropophagic Movement: devouring and transforming external influences
              into something genuinely Brazilian
            </p>
          </div>
        </div>
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <p className="text-lg mb-6">
            ...
            information is power, democratizing access to government data is democratizing power
            itself.
          </p>
          ...
          <p className="text-lg mb-8">
            ...
            decision is explainable, and where every citizen has the power to question, understand,
            and oversee.
          </p>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Transparency is a fundamental right</strong> - Every citizen has the right
                to know how their taxes are being used.
              </li>
              <li>
              ...
              <li>
                <strong>Complexity is the enemy of transparency</strong> - Public data should be
                presented clearly and accessibly to everyone.
              </li>
              <li>
                <strong>Civic vigilance strengthens democracy</strong> - An informed society is a
                stronger and more just society.
              </li>
              <li>
                <strong>Cultural identity matters</strong> - Our Brazilian roots and history should
                be reflected in the technologies we create.
              </li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-green-500 pl-4">
                ...
                <p>
                  To provide free, accessible, and reliable tools for monitoring public spending.
                </p>
              </div>
          ...
          <section className="mb-8">
            ...
            <p>We envision a Brazil where:</p>
