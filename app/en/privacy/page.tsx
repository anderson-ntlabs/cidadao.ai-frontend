...
export const metadata: Metadata = {
  ...
  description:
    'Cidadão.AI privacy policy. Learn how we protect your data and respect your privacy when using our public transparency system.',
  robots: 'index, follow',
  openGraph: {
    title: 'Privacy Policy - Cidadão.AI',
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 mt-2">
            ...
            <li>
              <strong>Conduct scientific research</strong> on usability and accessibility (with
              consent)
            </li>
            <li>
              <strong>Publish aggregated results</strong> in academic papers and theses
            </li>
            <li>
              <strong>Contribute to scientific advancement</strong> in digital public transparency
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            Aggregated and anonymized data may be shared publicly to promote government
            transparency.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            <a href="/en/cookies" className="text-green-600 hover:underline">
              Cookie Policy
            </a>
            .
          </p>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            Cidadão.AI is part of an academic research project on usability of public transparency
            systems. With your <strong>explicit consent</strong>, we may collect and use anonymized
            data for:
          </p>
          ...
          <ul className="list-disc pl-6 mb-4">
            <li>
              <strong>Complete anonymization:</strong> Personal data is removed or transformed into
              cryptographic hashes (SHA-256)
            </li>
            <li>
              <strong>Aggregation:</strong> Published results only in aggregated form, never
              individual
            </li>
            <li>
              <strong>Revocable consent:</strong> You can withdraw your consent at any time
            </li>
            <li>
              <strong>No commercialization:</strong> Research data will never be sold or shared
              commercially
            </li>
            <li>
              <strong>Transparency:</strong> Scientific publications will be shared publicly
            </li>
          </ul>
          ...
          <p className="mb-4">
            ...
            <strong>Article 7, IV of LGPD</strong>, which allows data processing for "conducting
            studies by research institutions, ensuring, whenever possible, the anonymization of
            personal data".
          </p>

          <h3 className="text-xl font-medium mb-2">8.4 How to Manage Your Consent</h3>
          <p>
            You can accept or decline data collection for research through the specific banner that
            appears when using the platform. Your choice does not affect access to system
            functionalities.
          </p>
        </section>
