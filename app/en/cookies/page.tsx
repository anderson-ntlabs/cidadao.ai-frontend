      ...
      <div className="prose prose-lg dark:prose-invert max-w-none">
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            us improve your browsing experience and ensure the site functions properly.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 mb-4">
            <li>
              <strong>Theme preference:</strong> Stores your choice between light/dark mode
            </li>
            <li>
              <strong>Language:</strong> Maintains your language preference (PT/EN)
            </li>
            <li>
              <strong>Session:</strong> Ensures continuity during your navigation
            </li>
            <li>
              <strong>Security:</strong> Protects against CSRF attacks
            </li>
          </ul>

          <h3 className="text-xl font-medium mb-2">2.2 Analytics Cookies (Optional)</h3>
          <p>
            We do not use tracking or analytics cookies. All metrics are collected in an aggregated
            and anonymous manner, without identifying individual users.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            <strong>We do not use third-party cookies.</strong> We do not share data with social
            networks, advertisers, or other external services.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            All cookies are transmitted over secure connection (HTTPS) and configured with
            appropriate security flags (Secure, HttpOnly, SameSite).
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            <a href="/en/privacy" className="text-green-600 hover:underline">
              {' '}
              Privacy Policy
            </a>{' '}
