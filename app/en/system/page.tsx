      ...
      <div className="max-w-4xl mx-auto px-6 py-24">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <section className="mb-12">
            ...
            <p>
              Cidadão.AI is built with a modern, scalable architecture designed to handle millions
              of requests while maintaining security and performance.
            </p>
          ...
          <section className="mb-12">
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="border-l-4 border-blue-500 pl-4">
                ...
                <p>
                  14 specialized agents handle specific domains like health, education, and
                  infrastructure.
                </p>
              </div>
              <div className="border-l-4 border-purple-500 pl-4">
                ...
                <p>
                  Agents communicate through an event-driven architecture for real-time
                  collaboration.
                </p>
              </div>
            </div>
          ...
          <section className="mb-12">
            ...
            <p>Our RESTful API is publicly available for developers and researchers:</p>
          ...
          <section className="mb-12">
            ...
            <p>All our code is open source under the MIT license. Explore our repositories:</p>
            <ul className="list-disc pl-6 mt-4 space-y-2">
              <li>
                <a
