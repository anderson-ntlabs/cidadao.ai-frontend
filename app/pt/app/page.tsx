                        ...
                        {card.badge && (
                          <span
                            className={cn(
                              ...
                              card.active ? 'bg-red-500 text-white' : 'bg-yellow-500 text-white'
                            )}
                          >
                            {card.badge}
                          </span>
                    ...
                    <GlassCardContent className="p-6">
                      <div className="flex items-start justify-between mb-4">
                        ...
                        {!card.active && (
                          <Badge
                            variant="outline"
                            className="bg-yellow-100 dark:bg-yellow-900/50 border-yellow-300 dark:border-yellow-700 text-yellow-800 dark:text-yellow-200"
                          >
                            Em Breve
                          </Badge>
                        )}
                      ...
                      <p className={cn('mb-4', 'text-gray-500 dark:text-gray-600')}>
                        {card.description}
                      </p>
