...
/**
 * Agora Trilhas Error Boundary
 *
 * Handles errors in the learning tracks page.
 *
...
export default function AgoraTrilhasError({ error, reset }: ErrorProps) {
  useEffect(() => {
    logger.error(error, {
      component: 'AgoraTrilhasPage',
      digest: error.digest,
      errorBoundary: true,
    })
  }, [error])
      ...
      <div className="max-w-md w-full">
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 border border-slate-200 dark:border-slate-700">
          ...
          <p className="text-center text-slate-600 dark:text-slate-400 mb-6">
            Nao conseguimos carregar as trilhas de aprendizado. Seu progresso esta salvo.
          </p>
