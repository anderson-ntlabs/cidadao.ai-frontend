...
/**
 * Agora Module Error Boundary
 *
 * Handles errors in individual module pages within learning tracks.
 *
...
export default function AgoraModuleError({ error, reset }: ErrorProps) {
  useEffect(() => {
    logger.error(error, {
      component: 'AgoraModulePage',
      digest: error.digest,
      errorBoundary: true,
    })
  }, [error])
      ...
      <div className="max-w-md w-full">
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 border border-slate-200 dark:border-slate-700">
          ...
          <p className="text-center text-slate-600 dark:text-slate-400 mb-6">
            Nao conseguimos carregar este modulo da trilha. Seu progresso esta salvo.
          </p>
          ...
          <div className="space-y-3">
            ...
            <Link href="/pt/agora/trilhas" className="block">
