...
/**
 * Agora Chat Error Boundary
 *
 * Copied from app/pt/app/chat/error.tsx and adapted for Agora chat.
 *
...
export default function AgoraChatError({ error, reset }: ErrorProps) {
  useEffect(() => {
    logger.error(error, {
      component: 'AgoraChatPage',
      digest: error.digest,
      errorBoundary: true,
    })
  }, [error])
            ...
            <Button
              onClick={() => {
                if (typeof window !== 'undefined') {
                  window.location.href = '/pt/agora/chat'
                }
              }}
              variant="secondary"
              className="w-full"
