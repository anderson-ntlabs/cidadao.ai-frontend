...
import { AlertTriangle, RefreshCcw, Home, Video } from 'lucide-react'
import { Button } from '@/components/ui/button'
import Link from 'next/link'
import { logger } from '@/lib/utils/logger'

/**
 * Agora Videos Error Boundary
 *
 * Handles errors in the video library page.
 *
...
export default function AgoraVideosError({ error, reset }: ErrorProps) {
  useEffect(() => {
    logger.error(error, {
      component: 'AgoraVideosPage',
      digest: error.digest,
      errorBoundary: true,
    })
  }, [error])
      ...
      <div className="max-w-md w-full">
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 border border-slate-200 dark:border-slate-700">
          ...
          <p className="text-center text-slate-600 dark:text-slate-400 mb-6">
            Nao conseguimos carregar a biblioteca de videos. Seu progresso esta salvo.
          </p>
          ...
          <div className="space-y-3">
            ...
            <Link href="/pt/agora/videos" className="block">
