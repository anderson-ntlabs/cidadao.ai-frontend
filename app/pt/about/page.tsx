...
export const metadata: Metadata = {
  ...
  description:
    'Projeto acadêmico inovador que combina IA, transparência pública e responsabilidade social para democratizar o acesso aos dados governamentais brasileiros.',
  keywords: [
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-24">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <p>
            Cada agente de IA carrega o nome e a missão de um herói brasileiro, desde Zumbi dos
            Palmares (detector de anomalias) até Ayrton Senna (agente de velocidade e eficiência).
            Essa abordagem única conecta tecnologia de ponta com nossa rica herança cultural,
            tornando a transparência pública mais próxima e significativa para cada brasileiro.
          </p>
          ...
          <p>
            O Cidadão.AI visa empoderar cada cidadão brasileiro com ferramentas para exercer seu
            direito constitucional de acesso à informação, promovendo uma democracia mais
            participativa e uma gestão pública mais transparente e eficiente.
          </p>
