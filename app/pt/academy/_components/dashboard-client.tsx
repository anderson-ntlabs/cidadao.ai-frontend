...
import { CertificateModal, LgpdConsentModal, BackgroundSelector } from '@/components/academy'
import {
  Trophy,
  Flame,
  Clock,
...
export function DashboardClient({
  ...
  const { currentBackground, getBackgroundStyle, getOverlayStyle } = useAcademyBackground()
              ...
              <div className="flex flex-col sm:flex-row gap-6">
                ...
                <div className="flex-1">
                  ...
                  <Button
                    onClick={() =>
                      router.push(
                        `/pt/academy/chat?agent=santos-dumont${isDemoMode ? '&demo=true' : ''}`
                      )
                    }
