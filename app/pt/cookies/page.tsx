      ...
      <div className="prose prose-lg dark:prose-invert max-w-none">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 mb-4">
            <li>
              <strong>Preferência de tema:</strong> Armazena sua escolha entre modo claro/escuro
            </li>
            <li>
              <strong>Idioma:</strong> Mantém sua preferência de idioma (PT/EN)
            </li>
            <li>
              <strong>Sessão:</strong> Garante a continuidade durante sua navegação
            </li>
            <li>
              <strong>Segurança:</strong> Protege contra ataques CSRF
            </li>
          </ul>

          <h3 className="text-xl font-medium mb-2">2.2 Cookies Analíticos (Opcionais)</h3>
          <p>
            Não utilizamos cookies de rastreamento ou análise. Todas as métricas são coletadas de
            forma agregada e anônima, sem identificar usuários individuais.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            <strong>Não utilizamos cookies de terceiros.</strong> Não compartilhamos dados com redes
        ...
        <section className="mb-8">
          ...
          <p className="mt-4">
            <strong>Atenção:</strong> Bloquear cookies essenciais pode afetar o funcionamento do
            site.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            Todos os cookies são transmitidos através de conexão segura (HTTPS) e configurados com
            flags de segurança apropriadas (Secure, HttpOnly, SameSite).
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            <a href="/pt/privacy" className="text-green-600 hover:underline">
              {' '}
              Política de Privacidade
            </a>{' '}
            ou entre em contato através do GitHub.
          </p>
        </section>
      </div>
    </div>
