      ...
      <div className="max-w-6xl mx-auto px-6 py-24">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <p className="text-xl text-gray-700 dark:text-gray-300 mb-8">
            O Cidadão.AI é um sistema multi-agente distribuído, construído com tecnologias modernas
            para garantir escalabilidade, confiabilidade e transparência total.
          </p>
          ...
          <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg">
            ...
            <div className="space-y-3 font-mono text-sm">
              ...
              <div>
                <span className="text-green-600">GET</span> /api/agents/{'{agent_id}'}/status -
                Status do agente
              </div>
              <div>
                <span className="text-blue-600">POST</span> /api/investigate - Solicitar
                investigação
              </div>
              <div>
              ...
              <div>
                <span className="text-yellow-600">WS</span> /ws/alerts - WebSocket para alertas em
                tempo real
              </div>
            </div>
          </div>
