      ...
      <div className="relative z-20 min-h-screen flex items-center justify-center px-6">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 mb-8 max-w-lg mx-auto">
            Parece que você se perdeu no caminho da transparência. A página que você procura não
          ...
          <div className="mt-12 p-6 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl border border-gray-200/50 dark:border-gray-700/50">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              ...
              O erro 404 significa que o servidor não conseguiu encontrar o recurso solicitado. É um
              dos códigos de status HTTP mais conhecidos!
            </p>
          </div>
